...
//	   static final String PASS = "0387002171";
    ...
    public static void main(String[] args) {
        ...
        // Open a connection
        try {
       	 String sql = "select * from acount "+ SystemConstant.ONE_EQUAL_ONE;
...
//           conn = DriverManager.getConnection(DB_URL, USER, PASS);
         ...
         while (rs.next()) {
       	  ...
       	  System.out.print(", NAME: "+rs.getString("username")+"-type: "+rsmd.getColumnType(2));
       	  System.out.println(", PASSWORD: "+rs.getString("password")+"-type: "+rsmd.getColumnType(3));
